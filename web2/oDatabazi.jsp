...
<div class="page">
    ...
    <div id="levaCastOdatabazi">
        ...
        <div class="nadpisStranky">Časté otázky</div>
          ...
          <li><a href="\" onclick="$('#komentareCP').slideToggle('slow'); return false;">Mohou larp hodnotit i lidé, kteří nebyli jeho hráči?</a></li>
          <div id="komentareCP" class="skryty" style="display: none;">Hráčem pro tyto účely míníme ryze účastníka akce. Larpu však za určitých okolností mohou být přítomni další lidé - organizátoři, CP (nehráčské vystupující postavy), přihlížející. Organizátor (případně spoluorganizátor) larpu by své hodnocení neměl přidávat za žádných okolností. V případě CP či přihlížejících ne-hráčů doporučujeme zdržet se procentuálního hodnocení, protože by mohlo zkreslovat celkové výsledky, ale vítáme jejich zasvěcené komentáře, které mohou být pro uživatele databáze relevantní.</div>

...
@Repository
@Transactional
public class SqlEmailAuthenticationTokens implements EmailAuthenticationService {
    private EmailAuthenticationDAO emailAuthenticationDAO;

    @Autowired
    public SqlEmailAuthenticationTokens(EmailAuthenticationDAO emailAuthenticationDAO) {

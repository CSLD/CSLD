...
@Component
public class UserMutationFetcherFactory {
    ...
    @Autowired
    public UserMutationFetcherFactory(CsldUsers csldUsers, EmailAuthentications emailAuthentications, AppUsers appUsers) {

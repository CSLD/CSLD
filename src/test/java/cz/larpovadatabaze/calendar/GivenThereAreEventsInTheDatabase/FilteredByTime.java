...
public class FilteredByTime extends AcceptanceTest {
    ...
    public void WhenUserRequestsEventsInGivenTimeFrame() {
        ...
        Event beforeTimeFrame = new Event(calendarForDate(2014, Calendar.OCTOBER, 12), calendarForDate(2014, Calendar.OCTOBER, 14));
        Event afterTimeFrame = new Event(calendarForDate(2016, Calendar.OCTOBER, 1), calendarForDate(2016, Calendar.OCTOBER, 3));
        Event fullyInTimeFrame = new Event(calendarForDate(2015, Calendar.NOVEMBER, 5), calendarForDate(2015, Calendar.NOVEMBER, 7));
